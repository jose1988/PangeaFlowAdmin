...
<nav class="navbar navbar-default" role="navigation">
      ...
      <div class="col-md-2" align="center">
	   ...
	   ?>
       		<div class="well well-small alert alert-block" align="center">
    			...
    			<h4>No se puede eliminar el registro de clasificación de rol</h4>
   			</div>
         ...
         <div class="well well-small alert alert-block" align="center">
    		<h2 style="color:#666">Atención</h2>
    		<h4>¿Desea eliminar el registro de clasificación de rol?</h4>
    	</div>
  ...
  <tbody>
      <?php
	  if(count($rowClasifRol->return)){

		  	echo '<tr>';
			echo '<td width="10%">'.$rowClasifRol->return->id.'</td>';
