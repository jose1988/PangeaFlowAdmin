  ...
  <tbody>
	  ...
	  if(count($rowGrupo->return)>1){   
		for ($i=0;$i<count($rowGrupo->return);$i++){
			...
			echo '<td width="20%">'.$rowGrupo[$i]->return->descripcion.'</td>';
			...
			echo '<td width="20%">'.$rowGrupo->return->descripcion.'</td>';
			echo '<td style="text-align:center" width="15%"><input type="checkbox" name="ide[0]" id="ide[0]" value='.$rowGrupo->return->id.'></td>';
			echo '</tr>';
