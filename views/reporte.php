  ...
  <tbody>
	  ...
	  if(count($resultadoListaReporte->return)>1){   
		for ($i=0;$i<count($resultadoListaReporte->return);$i++){
			...
			echo '<td style="text-align:center" width="15%"><a href="../pages/editarReporte.php?id='.$resultadoListaReporte->return[$i]->id.'"><button class="btn">Editar</button></td>';
			echo '<td style="text-align:center" width="15%"><a href="../pages/eliminarReporte.php?id='.$resultadoListaReporte->return[$i]->id.'"><button class="btn">Eliminar</button></td>';
			echo '<td style="text-align:center" width="15%"><a href="../pages/verReporte.php?id='.$resultadoListaReporte->return[$i]->id.'"><button class="btn">Ver</button></td>';	
			echo '</tr>';
			}
	  }
	  else{
			...
			echo '<td style="text-align:center" width="15%"><a href="../pages/editarReporte.php?id='.$resultadoListaReporte->return->id.'"><button class="btn">Editar</button></td>';
			echo '<td style="text-align:center" width="15%"><a href="../pages/eliminarReporte.php?id='.$resultadoListaReporte->return->id.'"><button class="btn">Eliminar</button></td>';
			echo '<td style="text-align:center" width="15%"><a href="../pages/verReporte.php?id='.$resultadoListaReporte->return->id.'"><button class="btn">Ver</button></td>';	
			echo '</tr>';
		  }
		?>
		</tbody>	
