  ...
  <tbody>
	  ...
	  if(count($rowRol->return)>1){   
		for ($i=0;$i<count($rowRol->return);$i++){
			...
			echo '<td style="text-align:center" width="15%"><a href="javascript:habilitar('.$rowRol->return[$i]->id.')"><button class="btn">Habilitar</button></td>';
			echo '</tr>';
			}
	  }
	  else{
			...
			echo '<td style="text-align:center" width="15%"><a href="javascript:habilitar('.$rowRol->return->id.')"><button class="btn">Habilitar</button></td>';
			echo '</tr>';
