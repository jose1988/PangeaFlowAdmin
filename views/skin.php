      ...
      <div class="col-md-2" align="center">
	   ...
	   ?>
       		<div class="well well-small alert alert-block" align="center">
    			...
    			<h4>No Existen Registros en Skin</h4>
   			</div>
  ...
  <tbody>
	  ...
	  if(count($resultadoListaSkin->return)>1){   
		for ($i=0;$i<count($resultadoListaSkin->return);$i++){
			...
			echo '<td style="text-align:center" width="15%"><a href="../pages/editarSkin.php?id='.$resultadoListaSkin->return[$i]->id.'"><button class="btn">Editar</button></td>';
			echo '<td style="text-align:center" width="15%"><a href="../pages/eliminarSkin.php?id='.$resultadoListaSkin->return[$i]->id.'"><button class="btn">Eliminar</button></td>';
			echo '<td style="text-align:center" width="15%"><a href="../pages/verSkin.php?id='.$resultadoListaSkin->return[$i]->id.'"><button class="btn">Ver</button></td>';
			echo '</tr>';
			}
	  }
	  else{
			...
			echo '<td style="text-align:center" width="15%"><a href="../pages/editarSkin.php?id='.$resultadoListaSkin->return->id.'"><button class="btn">Editar</button></td>';
			echo '<td style="text-align:center" width="15%"><a href="../pages/eliminarSkin.php?id='.$resultadoListaSkin->return->id.'"><button class="btn">Eliminar</button></td>';
			echo '<td style="text-align:center" width="15%"><a href="../pages/verSkin.php?id='.$resultadoListaSkin->return->id.'"><button class="btn">Ver</button></td>';
			echo '</tr>';
