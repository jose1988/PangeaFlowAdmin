...
<div class="col-md-2" align="center">
        ...
        <table width="100%" class="table-striped table-bordered table-condensed">
			 ...
			 <th width="40%">Nombre</th>
				 <td><input type="text" name="nombre" id="nombre" maxlength="49" size="50" title="Ingrese el nombre" placeholder="Ej. Jefe" autofocus required></td>
			 </tr>
			 <tr>
			 <th width="40%">Descripión</th>
				 <td><input type="text" name="descripcion" id="descripcion" maxlength="149" size="50" title="Ingrese la descripción" placeholder="Ej. Jefe inmediato " required="required"></td>
			 </tr>
